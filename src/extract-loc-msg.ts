 ...
 */
const {computeMsgId} = require( '@angular/compiler');
const BLOCK_MARKER = module.exports.BLOCK_MARKER = ':';
const ID_SEPARATOR = module.exports.ID_SEPARATOR = '@@';
const MEANING_SEPARATOR = module.exports.MEANING_SEPARATOR = '|';

/**
 * Re-export this helper function so that users of `@angular/localize` don't need to actively import
 * from `@angular/compiler`.
 */
module.exports.computeMsgId = computeMsgId
 ...
 */
module.exports.parseMessage = function parseMessage(
 ...
 */
const parseMetadata = module.exports.parseMetadata = function parseMetadata(cooked: string, raw: string): MessageMetadata {
 ...
 */
 function splitBlock(cooked: string, raw: string): {text: string, block?: string} {
  raw = raw || cooked;
